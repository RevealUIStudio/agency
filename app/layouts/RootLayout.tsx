...
export function RootLayout({ children }: { children: ReactNode }) {
  ...
  // `pathname` is the trigger, not a value the body reads. Removing it (the
  // rule's autofix) would run this once on mount and never again, silently
  // breaking focus + scroll reset on every client-side navigation.
