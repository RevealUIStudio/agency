import { ARCHITECTURE_ARTIFACT_BUNDLE } from '@/lib/engagements';
    ...
    <section className="bg-background py-16 sm:py-24">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <p className="mt-6 text-lg text-muted-foreground">
          ...
          take paid studio work: Hour, {ARCHITECTURE_ARTIFACT_BUNDLE.name}, and Launch. Remote
          first. Sitting down in {STUDIO_CITY} is available on the same calendar.
        </p>
