      ...
      <section className="bg-background py-16 sm:py-24">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            Three paid offers. They operate, or they pay to implement. Use the homepage calculator,
            or book a 30-minute intro first. I invoice after we agree. There is no public checkout.{' '}
