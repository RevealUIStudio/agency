...
- Shared workboard at `~/revfleet/.jv/.claude/workboard.md` — read on session start
- Master plan at `~/revfleet/.jv/docs/MASTER_PLAN.md` (§5.21 Agency site)
- Multi-agent coordination plan: `~/revfleet/.jv/docs/multi-agent-coordination-plan.md`
- Predecessor handoffs in `~/revfleet/.jv/docs/HANDOFF-*.md` (most recent: 2026-05-01 comprehensive EOD)

## Brand naming

See `~/revfleet/.jv/docs/brand-naming.md` for the canonical convention.
...
RevealUI Studio <founder@revealui.com> (per `~/revfleet/.jv/.claude/rules/git.md`)
